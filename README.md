...
A. Standard Benchmark (STL-10) Main experiment evaluating performance on color images (96x96).
Bash

python main.py --dataset stl10 --epochs 20
B. Robustness Test (Fashion-MNIST) Evaluates adaptability to grayscale images (28x28) with different feature scales.
Bash

python main.py --dataset fashion --epochs 15
C. Theoretical Validation (Synthetic Data) Trains on a custom dataset of vertical vs. horizontal bars to validate edge detection capabilities.
Bash 
